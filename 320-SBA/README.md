My name is Abigail and this is my 320 React SBA, where I made a weather app that uses an external API to retrieve data about cities weather conditions around the world. 
